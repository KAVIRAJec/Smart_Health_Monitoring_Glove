...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Oxygen(SpO2) with respect to time"
	},
	axisY: {
		title: "SpO2 per Minute",
		minimum: 95,
        maximum: 100,
        interval: 1,
	},
...
<body>
<form>
 <input type="button" class="custom-btn btn-1" class="custom-btn btn-1" value="Go back!" onclick="history.back()">
</form>
