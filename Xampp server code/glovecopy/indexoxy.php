...
<form>
 <input type="button" class="custom-btn btn-2" value="Go back!" onclick="history.back()">
    ...
    <h1>Blood Oxygen Level From the Database</h1>
...
$sql = "SELECT id, oxy FROM parameter";
...
<a href="api/graphjsoxy.php">
    <button class="custom-btn btn-1">Oxygen Graph</button></a>
</body>
</html>
<style>
      .custom-btn {
